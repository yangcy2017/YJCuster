...
CREATE TABLE `cust_rela`  (
  ...
  `RELA_CUST_KILL_TIME` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '新客户进场时间'
...
CREATE TABLE `killer_cust`  (
  ...
  `CUST_FTIME` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '客户开户时间',
